...
import btcpayIllustration from "../../assets/btcpay-illustration.svg";
...
const Products = () => {
    ...
    return (
        <div class="products-plugin">
            <div class="header">
                <h2>{t("boltz_plugin_name")}</h2>
                <h1>{t("boltz_plugin_description")}</h1>
            </div>
            <div class="content">
                <div class="illustration">
                    <img src={btcpayIllustration} alt="Plugin illustration" />
                    <div class="bg-neon" />
                </div>
                ...
                <div class="grid">
                    <div class="features-grid">
                        <span class="features-header">
                            <h2>{t("boltz_plugin_features_title")}</h2>
                        ...
                        <div class="content-item-buttons">
                            <a
                                ...
                                target="_blank">
                                <span>
                                    {t("boltz_plugin_documentation_button")}
                                </span>
                                <OcLinkexternal2 />
                            </a>
                            <a
                                ...
                                target="_blank">
                                <span>{t("boltz_plugin_github_button")}</span>
                                <BsGithub />
                            </a>
                        </div>
                    </div>
                ...
                <div class="call-to-action">
                    <h1>{t("boltz_plugin_questions_title")}</h1>
                    <p>{t("boltz_plugin_questions_subtitle")}</p>
                    <button class="btn-primary">
                        <span>{t("boltz_plugin_chat_button")}</span>
                        <ChatIcon />
                    </button>
                </div>
            </div>
