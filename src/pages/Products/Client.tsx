...
const Products = () => {
    ...
    return (
        <div class="products-client">
            <div class="header">
                <h2>{t("boltz_client_name")}</h2>
                <h1>{t("boltz_client_description")}</h1>
            </div>
            <div class="content">
                <div class="features">
                ...
                <div class="cli-section">
                    <div class="cli-details">
                        <h2>{t("botz_client_cli_title")}</h2>
                        <span>
                            <p>{t("boltz_client_cli_first_paragraph")}</p>
                            <p>{t("boltz_client_cli_second_aragraph")}</p>
                        </span>
                    </div>
                    <div class="cli">
                ...
                <div class="call-to-action">
                    <div class="text">
                        <h1>{t("boltz_client_cta_title")}</h1>
