...
export declare namespace Router {
    ...
    export type ClaimSendAuthorizationStruct = {
    ...
    export type ClaimSendAuthorizationStructOutput = [
        minAmountLd: bigint,
        lzTokenFee: bigint,
        refundAddress: string,
        v: bigint,
...
export interface RouterInterface extends Interface {
    ...
    encodeFunctionData(
        functionFragment: "TYPEHASH_CLAIM_SEND",
        values?: undefined,
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
        functionFragment: "TYPEHASH_SEND_DATA",
        values?: undefined,
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
        functionFragment: "claimERC20ExecuteOft",
        values: [
            Router.Erc20ClaimStruct,
            Router.CallStruct[],
            AddressLike,
            AddressLike,
            Router.SendDataStruct,
            Router.ClaimSendAuthorizationStruct,
        ],
    ): string;
    encodeFunctionData(
...
export interface Router extends BaseContract {
    ...
    TYPEHASH_CLAIM_SEND: TypedContractMethod<[], [string], "view">;

    TYPEHASH_EXECUTE_LOCK_ERC20: TypedContractMethod<[], [string], "view">;

    TYPEHASH_SEND_DATA: TypedContractMethod<[], [string], "view">;
    ...
    claimERC20ExecuteOft: TypedContractMethod<
        [
            claim: Router.Erc20ClaimStruct,
            calls: Router.CallStruct[],
            token: AddressLike,
            oft: AddressLike,
            sendData: Router.SendDataStruct,
            auth: Router.ClaimSendAuthorizationStruct,
        ],
        [void],
        "payable"
    >;
    ...
    getFunction(
        nameOrSignature: "TYPEHASH_CLAIM_SEND",
    ): TypedContractMethod<[], [string], "view">;
    getFunction(
        nameOrSignature: "TYPEHASH_EXECUTE_LOCK_ERC20",
    ): TypedContractMethod<[], [string], "view">;
    getFunction(
        nameOrSignature: "TYPEHASH_SEND_DATA",
    ): TypedContractMethod<[], [string], "view">;
    getFunction(
    ...
    >;
    getFunction(
        nameOrSignature: "claimERC20ExecuteOft",
    ): TypedContractMethod<
        [
            claim: Router.Erc20ClaimStruct,
            calls: Router.CallStruct[],
