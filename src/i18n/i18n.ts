const dict = {
    ...
    zh: {
        ...
        fast: "快速",
        l2: "建立在第二层之上",
        l2_sub: "Boltz利用像Liquid和闪电网络这样的第二层扩展技术",
        ...
        documentation: "文档",
        onion: "洋葱",
        blockexplorer: "打开{{ typeLabel }}的区块浏览器",
        ...
        send_to:
            "请确保将准确的{{ amount }}{{ denomination }}发送到下面显示的地址。否则，交换将失败。最好使用“复制 BIP21”按钮,并将其粘贴到您钱包的发送屏幕中。",
        ...
        invalid_invoice: "请提供有效的LN发票、LN地址或LNURL",
        ...
        view: "查看",
        id: "ID",
        headline: "隐私第一，非托管比特币交换",
        subline: "不能邪恶。您掌控着您的资金。一直如此。",
        start_swapping: "开始交换",
        partners: "合作伙伴",
        integrations: "集成",
