const dict = {
    en: {
        ...
        solana_token_account_fee_label: "Solana Account Creation",
        solana_token_account_fee_abbrev: "SAC fee",
    ...
    de: {
        ...
        solana_token_account_fee_label: "Solana-Kontoerstellung",
    ...
    es: {
        ...
        solana_token_account_fee_label: "Creacion de cuenta de Solana",
    ...
    pt: {
        ...
        solana_token_account_fee_label: "Criacao de conta da Solana",
    ...
    zh: {
        ...
        solana_token_account_fee_label: "Solana 账户创建",
    ...
    ja: {
        ...
        solana_token_account_fee_label: "Solanaアカウント作成",
