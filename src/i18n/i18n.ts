const dict = {
    en: {
        ...
        connect_wallet_to_continue: "Connect wallet to continue",
    ...
    de: {
        ...
        connect_wallet_to_continue: "Wallet verbinden, um fortzufahren",
    ...
    es: {
        ...
        connect_wallet_to_continue: "Conecta el monedero para continuar",
    ...
    pt: {
        ...
        connect_wallet_to_continue: "Conecte a carteira para continuar",
    ...
    zh: {
        ...
        no_wallet: "未安装钱包",
        connect_wallet: "连接钱包",
        connect_wallet_to_continue: "连接钱包以继续",
    ...
    ja: {
        ...
        connect_wallet_to_continue: "続行するにはウォレットを接続",
