const dict = {
    en: {
        ...
        evm_rescue_refund_explainer:
            "Connect your wallet to scan for EVM swaps that have expired and can be refunded. If you sent USDT0, USDC, TBTC or WBTC into a Boltz swap, use your Rescue Key to find it. Rescue Key is not necessary to refund RBTC.",
    ...
    de: {
        ...
        evm_rescue_refund_explainer:
            "Verbinde dein Wallet, um nach EVM-Swaps zu suchen, die abgelaufen sind und erstattet werden können. Wenn du USDT0, USDC, TBTC oder WBTC in einen Boltz-Swap gesendet hast, nutze deinen Rettungsschlüssel, um ihn zu finden. Für die Rückerstattung von RBTC ist kein Rettungsschlüssel erforderlich.",
    ...
    es: {
        ...
        evm_rescue_refund_explainer:
            "Conecta tu monedero para buscar intercambios EVM que hayan expirado y puedan reembolsarse. Si enviaste USDT0, USDC, TBTC o WBTC a un intercambio de Boltz, usa tu clave de rescate para encontrarlo. No se necesita la clave de rescate para reembolsar RBTC.",
    ...
    pt: {
        ...
        evm_rescue_refund_explainer:
            "Conecte sua carteira para procurar trocas em EVM que expiraram e podem ser reembolsadas. Se você enviou USDT0, USDC, TBTC ou WBTC para uma troca da Boltz, use sua chave de resgate para encontrá-la. A chave de resgate não é necessária para reembolsar RBTC.",
    ...
    zh: {
        ...
        evm_rescue_refund_explainer:
            "连接你的钱包以扫描已过期且可退款的 EVM 交换。如果你向 Boltz 交换发送了 USDT0、USDC、TBTC 或 WBTC，请使用你的救援密钥来找到该交换。退还 RBTC 不需要救援密钥。",
        start_scanning: "开始扫描",
        stop_scanning: "停止扫描",
    ...
    ja: {
        ...
        evm_rescue_refund_explainer:
            "ウォレットを接続して、期限切れで返金可能な EVM スワップをスキャンします。USDT0、USDC、TBTC または WBTC を Boltz スワップに送金した場合は、レスキューキーを使ってそのスワップを見つけてください。RBTC の返金にはレスキューキーは不要です。",
