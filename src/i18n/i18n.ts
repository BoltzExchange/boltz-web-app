const dict = {
    en: {
        ...
        waiting_liquid_confirmation: "Waiting for Liquid confirmation...",
        ...
        sideswap_finalizing: "Finalizing SideSwap trade",
        sideswap_checking_change: "Checking for remaining funds...",
        sideswap_complete: "SideSwap trade complete",
        sideswap_failed: "SideSwap trade failed",
        sideswap_refund_description:
            "Enter a Liquid address to sweep the intermediate {{ asset }} to.",
    ...
    de: {
        ...
        preparing_sideswap: "SideSwap-Trade wird vorbereitet...",
        waiting_liquid_confirmation: "Warte auf Liquid-Bestätigung...",
        sideswap_quoting: "SideSwap-Angebot wird abgerufen",
        getting_sideswap_quote:
            "Rufe das beste verfügbare Angebot von SideSwap ab...",
        sideswap_signing: "Trade wird signiert",
        signing_sideswap_transaction:
            "SideSwap-Transaktion wird signiert und gesendet...",
        sideswap_finalizing: "SideSwap-Trade wird abgeschlossen",
        sideswap_checking_change: "Prüfe verbleibende Beträge...",
        sideswap_complete: "SideSwap-Trade abgeschlossen",
        sideswap_failed: "SideSwap-Trade fehlgeschlagen",
        sideswap_refund_description:
            "Gib eine Liquid-Adresse ein, um die Zwischen-{{ asset }} dorthin zu senden.",
        sideswap_transaction: "Transaktion",
    ...
    es: {
        ...
        sideswap_fee: "Comisión de Sideswap",
