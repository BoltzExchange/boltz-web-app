const dict = {
    ...
    ru: {
        ...
        send_to: "Отправьте {{ amount }} {{ denomination }} на",
        send_between:
            "Отправьте между {{ min }} и {{ max }} {{ denomination }} на",
        pay_invoice_to:
        ...
        select_derivation_path: "Выберите путь деривации",
        submit_derivation_path: "Подтвердить",
        not_supported_in_browser: "Не поддерживается в этом браузере",
        ...
        validate_payment: "Показать подтверждение оплаты",
