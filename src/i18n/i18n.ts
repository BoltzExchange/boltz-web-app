const dict = {
    en: {
        ...
        fast: "Fast",
        l2: "Built on Layer 2",
        l2_sub: "Utilizes Layer 2 scaling technologies like the Lightning Network",
        ...
        assets: "Multi-Layer",
        footer: "Maintained with ❤️ by Team SwapMarket",
        ...
        create_swap_subline: "Payment Includes Network and Provider's Fee",
        ...
        transaction_refunded: "Provider has refunded the Transaction",
        ...
        on: "on",
        off: "off",
        notification_header: "SwapMarket",
    ...
    de: {
        ...
        l2_sub: "Nutzt Layer-2 Skalierungstechnologien wie das Lightning-Netzwerk",
        assets_sub: "Lightning / Bitcoin / Liquid / Rootstock",
        safe: "Sicher",
        non_custodial: "Non-Custodial",
        non_custodial_sub:
        ...
        assets: "Multi-layer",
        footer: "Gepflegt mit ❤️ von Team SwapMarket",
        ...
        create_swap_subline: "Zahlung beinhaltet Netzwerk- und Anbietergebühr",
        ...
        transaction_refunded: "Anbieter hat die Transaktion erstattet.",
    ...
    es: {
        ...
        l2_sub: "Utiliza tecnologías de segunda capa como la red de Lightning",
        assets_sub: "Lightning / Bitcoin / Liquid / Rootstock",
        safe: "Seguro",
        ...
        assets: "Multicapa",
        footer: "Mantenido con ❤️ por el equipo de SwapMarket",
        ...
        create_swap_subline:
            "El pago incluye la comisión de red y servicio del proveedor",
        ...
        transaction_refunded: "El proveedor ha reembolsado la transacción!",
    ...
    zh: {
        ...
        assets: "多层",
        footer: "SwapMarket团队倾情 ❤️ 维护",
        create_channel: "创建闪电网络通道",
        create_channel_subline: "通道入站或出站容量",
        create_swap: "创建原子交换",
        create_swap_subline: "付款包括网络和提供者服务费",
        cancel_swap: "取消交换",
        new_swap: "新的交换",
        success_swap: "交换成功",
        ...
        transaction_refunded: "提供者已退款交易!",
        refunded: "交换已退还",
        broadcasted: "退款已广播",
        locktime_not_satisfied: "未满足锁定时间要求",
        already_refunded: "交换已经退还",
        api_offline: "API离线",
        api_offline_msg: "无法连接到提供者 API,请稍后重试",
    ...
    ja: {
        ...
        alias: "エイリアス",
        fee_short: "手数料",
        select_backend: "交換プロバイダーを選択",
        contact: "交換の問題？ {{ alias }}に連絡する:",
        fast: "高速",
        l2: "L2技術を活用",
        l2_sub: "Layer 2スケーリング技術を活用しています",
        assets_sub: "Lightning / Bitcoin / Liquid / Rootstock",
        safe: "安全",
        non_custodial: "ノンカストディアル型",
        non_custodial_sub:
            "スワップはノンカストディアル型で、ユーザーは常に資金を自己管理できます",
        node: "ノード",
        lightningnode: "Lightningノードを表示",
        error: "エラー",
        error_subline: "APIからの無効な応答です。何かが間違っています",
        error_wasm: "WebAssemblyがサポートされていません",
        history: "履歴",
        swap: "スワップ",
        channel: "チャネル",
        refund: "返金",
        ...
        pay_invoice_to: "{{ amount }} {{ denomination }} のインボイスを支払う",
        pay_address: "アドレス",
        no_wallet: "ウォレットが接続されていません",
        connect_wallet: "ウォレットを接続",
        please_connect_wallet: "ウォレットを接続してください",
        connect_to_address: "交換アドレスに接続",
        disconnect_address: "ウォレットを切断",
        ...
        invalid_invoice:
            "有効なLNインボイス、LNアドレス、またはLNURLを指定してください",
        invalid_0_amount: "金額なしのインボイスはサポートされていません",
        ...
        copied: "コピーされました！",
        backup_skip: "スキップ",
        backup_refund: "返金ファイルをダウンロード",
        backup_refund_subline:
            "このスワップが失敗した場合、返金するために返金ファイルが必要になります。返金キーはブラウザに保存されますが、次の場合失われる可能性があります",
        backup_refund_list_incognito: "シークレットモードを使用している",
        backup_refund_list_tor: "Torブラウザを使用している",
        backup_refund_list_clear_history: "ブラウザ履歴をクリアする",
        backup_refund_skip:
            "これらの条件が適用される場合は、返金ファイルをダウンロードすることを強くお勧めします！",
        refund_a_swap: "スワップを返金する",
        refund_swap: "スワップを返金する {{ id }}",
        refund_a_swap_subline:
        ...
        refund_address_header: "返金先アドレスを入力してください",
        refund_address_header_no_asset: "返金先アドレスを入力してください",
        refund_backup: "バックアップ",
        refund_import: "バックアップをインポート",
        refund_clear: "ローカルストレージをクリア",
        delete_swap: "ローカルストレージからスワップを削除",
        delete_storage:
            "本当にストレージをクリアしますか？\nスワップ情報と秘密鍵が失われます。",
        delete_storage_single_swap:
            "{{ id }}のスワップを削除しますか？\nスワップ情報と返金/請求の秘密鍵が失われます。",
        delete_logs: "ログを削除してもよろしいですか？",
        ...
        transaction_refunded: "トランザクションが返金されました",
        refunded: "スワップが正常に返金されました！",
        broadcasted: "返金が送信されました",
        locktime_not_satisfied: "ロックタイムが満たされていません",
        already_refunded: "スワップはすでに返金されています",
        api_offline: "APIがオフラインです",
        api_offline_msg:
            "プロバイダーのAPIに接続できませんでした。後でもう一度お試しください。",
        refund_explainer: "タイムアウト後に返金できます",
        swap_not_refundable_yet: "まだスワップは返金できません",
        wasm_not_supported: "WebAssemblyを有効にしてください",
        ios_image_download_do_not_share: "機密情報です。共有しないでください。",
        ios_image_download:
            "長押しして「写真に保存」を選択すると払い戻しファイルをダウンロードできます",
        created: "作成済み",
        view: "表示",
        id: "ID",
        headline: "非管理型ビットコインスワップマーケットプレイス",
        subline: "ビットコインのプライバシーファースト型ノンカストディアル交換",
        ...
        peers: "ピアの数",
        num_channels: "チャネルの数",
        beta_caution: "ベータ版のため、ご利用は慎重にお願いします！",
        warning_return: "インボイスのお支払い後、このページに戻ってください！",
        warning_expiry: "交換の作成後、約24時間以内に確認が必要です！",
        not_found: "404 - ページが見つかりません",
        not_found_subline: "探しているページは存在しません。",
        back_to_home: "ホームに戻る",
        transaction_prompt:
            "接続されたウォレットを開き、表示された取引を確認するには、「{{ button }}」を押します。",
        invalid_address: "無効なアドレス {{ asset }}",
        scan_qr_code: "QRコードをスキャン",
        version: "バージョン",
        commithash: "コミットハッシュ",
        open_in_wallet: "ウォレットで開く",
        invoice_paid: "インボイスが支払われました",
        creating_coop_claim: "協調請求取引を作成します。",
        branding: "ブランディング",
        testnet: "テストネット",
        broadcasting_claim: "クレーム取引を放送しています...",
        open_swap: "オープンスワップ",
        swap_in_history: "履歴にスワップが見つかりました。",
        paste_invalid:
            "クリップボードに無効な文字が含まれているか、最大数を超えています",
        email: "メール",
        switch_paste:
            "貼り付けられたコンテンツに基づいてスワップ方向/アセットを切り替えました",
        settings: "設定",
        decimal_separator: "小数点区切り",
        denomination_tooltip: "Choose your preferred denomination: BTC or sats",
        decimal_tooltip:
            "好みの小数点記号を選択してください: ドットまたはカンマ",
        swap_completed: "スワップ {{ id }} が成功しました！",
        claim_fail: "スワップ {{ id }} の請求に失敗しました",
        logs: "ログ",
        logs_tooltip: "デバッグに役立つウェブアプリケーションのログ",
        enable_audio_notifications: "オーディオ通知",
        enable_audio_notifications_tooltip:
            "オーディオ通知のオン/オフを切り替えます",
        on: "オン",
        off: "オフ",
        notification_header: "SwapMarket",
        browsernotification: "ブラウザ通知",
        browsernotification_tooltip: "ブラウザ通知のオン/オフを切り替えます",
        browsernotification_error: "通知アクセスが拒否されました",
        invalid_pair: "無効なペア",
        reckless_mode_setting: "無謀モード",
        reckless_mode_setting_tooltip:
            "ファイルのダウンロード要求や確認手順を無効化します",
        error_starting_qr_scanner:
            "カメラにアクセスできません。権限を確認してください！",
        insufficient_balance: "残高不足",
        insufficient_balance_line:
            "ウォレットの残高がこのスワップに必要な金額に達していません。",
    ...
    ru: {
        ...
        alias: "Псевдоним",
        fee_short: "Комиссия",
        select_backend: "Выбор контрагента",
        contact: "Проблема со свопом? Свяжитесь с {{ alias }}:",
        fast: "Быстро",
        l2: "На базе Layer 2",
        l2_sub: "Использует технологии масштабирования Layer 2, такие как Lightning Network",
        assets_sub: "Lightning / Bitcoin / Liquid / Rootstock",
        safe: "Безопасно",
        non_custodial: "Без посредников",
        non_custodial_sub:
            "Сбопы являются атомарными, криптография гарантирует, что пользователи всегда контролируют свои деньги",
        node: "Статистика провайдера",
        lightningnode: "Просмотр узлов Lightning",
        error: "Ошибка",
        error_subline: "Некорректный ответ от API, что-то пошло не так.",
        error_wasm: "WebAssembly не поддерживается",
        history: "История",
        swap: "Своп",
        channel: "Канал",
        refund: "Возврат",
        ...
        onion: "Onion",
        blockexplorer: "открыть {{ typeLabel }}",
        blockexplorer_lockup_address: "адрес блокировки",
        blockexplorer_lockup_tx: "транзакцию блокировки",
        blockexplorer_claim_tx: "транзакцию требования",
        blockexplorer_refund_tx: "транзакцию возврата",
        help: "Помощь",
        network_fee: "Сетевой сбор",
        fee: "Комиссия провайдера",
        ...
        min: "Мин",
        max: "Макс",
        minimum_amount: "Минимальная сумма {{ amount }} {{ denomination }}",
        maximum_amount: "Максимальная сумма {{ amount }} {{ denomination }}",
        assets: "Мульти-слой",
        footer: "Поддерживается с ❤️ командой SwapMarket",
        create_channel: "Создать Lightning канал",
        create_channel_subline: "Входящая или исходящая емкость канала",
        create_swap: "Создать атомарный своп",
        create_swap_subline: "Платеж включает сетевой и провайдерский сбор",
        cancel_swap: "Отменить своп",
        new_swap: "Новый своп",
        success_swap: "Своп успешно завершен",
        feecheck:
        ...
        timeout_eta: "Ожидаемое время завершения",
        pay_invoice: "Своп: {{ id }}",
        pay_swap_404: "Своп не найден!",
        pay_timeout_blockheight: "Блок высоты завершения",
        pay_expected_amount: "Ожидаемая сумма",
        send_to: "Отправить {{ amount }} {{ denomination }} на",
        pay_invoice_to:
            "Оплатить этот инвойс на сумму {{ amount }} {{ denomination }}",
        pay_address: "Адрес",
        no_wallet: "Кошелек не установлен",
        connect_wallet: "Подключить кошелек",
        please_connect_wallet: "Пожалуйста, подключите кошелек",
        connect_to_address: "Подключить к адресу свопа",
        disconnect_address: "Отключить кошелек",
        lockup_failed: "Не удалось заблокировать!",
        lockup_failed_subline:
            "Ваша транзакция блокировки не удалась, дождитесь тайм-аута для возврата.",
        ...
        invalid_invoice:
            "Пожалуйста, укажите действительный LN инвойс, LNAddress или LNURL",
        invalid_0_amount: "Инвойсы без суммы не поддерживаются",
        copy_invoice: "lightning инвойс",
        copy_address: "адрес",
        copy_amount: "сумма",
        copy_bip21: "BIP21",
        copied: "Скопировано!",
        ...
        refund_address_header_no_asset:
            "Введите адрес вашего кошелька для возврата",
        refund_backup: "Резервная копия",
        refund_import: "Импортировать резервную копию",
        refund_clear: "Очистить память",
        delete_swap: "Удалить своп из памяти",
        delete_storage:
            "Вы уверены, что хотите очистить память?\nИнформация о ваших свопах и приватные ключи для возврата/требования будут утеряны.",
        delete_storage_single_swap:
            "Вы уверены, что хотите удалить своп {{ id }} из памяти?\nИнформация о свопе и приватные ключи для возврата/требования будут утеряны.",
        delete_logs: "Вы уверены, что хотите удалить логи?",
        tx_in_mempool: "Транзакция в мемпуле",
        tx_in_mempool_subline: "Ожидаем подтверждения для завершения свопа",
        expired: "Своп истек!",
        ...
        refunded: "Своп был успешно возвращен!",
        broadcasted: "Возврат отправлен",
        locktime_not_satisfied: "Требование по времени блокировки не выполнено",
        already_refunded: "Своп уже возвращен",
        api_offline: "API недоступно",
        api_offline_msg:
            "Не удалось подключиться к API провайдера, попробуйте позже",
        refund_explainer: "Вы сможете вернуть средства после тайм-аута",
        swap_not_refundable_yet: "Ваш своп еще нельзя вернуть",
        wasm_not_supported:
            "Пожалуйста, активируйте WebAssembly в вашем браузере",
        ios_image_download_do_not_share: "КОНФИДЕНЦИАЛЬНО! НЕ РАСПРОСТРАНЯЙТЕ!",
        ios_image_download:
            'Нажмите и удерживайте, затем выберите "Сохранить в фото", чтобы скачать файл возврата',
        created: "Создано",
        view: "Просмотр",
        id: "ID",
        ...
        oldest_channel_years: "{{ years }} лет",
        oldest_channel: "Старейший канал",
        capacity: "Емкость ({{ denomination }})",
        peers: "Число пиров",
        ...
        transaction_prompt:
            'Нажмите "{{ button }}", чтобы открыть подключенный кошелек и подтвердить транзакцию.',
        ...
        open_swap: "Открыть своп",
        swap_in_history: "Своп найден в истории.",
        paste_invalid:
            "Буфер обмена содержит недопустимые символы или превышено максимальное количество",
        email: "Электронная почта",
        switch_paste:
            "Направление/актив свопа изменены на основе вставленного содержимого",
        settings: "Настройки",
        decimal_separator: "Десятичный разделитель",
        denomination_tooltip:
            "Выберите предпочитаемую деноминацию: BTC или сатоши",
        decimal_tooltip:
            "Выберите предпочитаемый десятичный разделитель: точка или запятая",
        swap_completed: "Своп {{ id }} успешно завершен!",
