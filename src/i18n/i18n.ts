const dict = {
    en: {
        ...
        oft_eta: "Estimated arrival in about {{ seconds }}s",
    ...
    de: {
        ...
        oft_eta: "Voraussichtliche Ankunft in etwa {{ seconds }}s",
    ...
    es: {
        ...
        oft_eta: "Llegada estimada en aproximadamente {{ seconds }}s",
    ...
    pt: {
        ...
        oft_eta: "Chegada estimada em cerca de {{ seconds }}s",
