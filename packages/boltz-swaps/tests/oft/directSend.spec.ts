...
import type * as ConfigModule from "boltz-swaps/config";
import type {
    OftContract,
    OftDirectSendTarget,
    OftRoute,
...
vi.mock("boltz-swaps/config", async (importActual) => ({
