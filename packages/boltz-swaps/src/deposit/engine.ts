...
// Forwarded-mint poll deadline before falling back to a manual self-mint.
...
export const advanceDeposit = async (
    ...
    while (!isTerminalPhase(record.phase)) {
        ...
        try {
            ...
            // Business failure: refund the locked commitment, or fail outright
            // when nothing was locked yet.
            await persist({
                ...record,
                phase:
