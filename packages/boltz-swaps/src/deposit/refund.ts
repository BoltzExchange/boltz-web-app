...
// Cooperatively refund an UNBOUND empty-preimage commitment (e.g. the consumer
// rejected the quote). The lockup args are re-parsed from the commitment tx so
// no extra state is persisted.
