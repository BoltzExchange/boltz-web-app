...
describe("BlockExplorer", () => {
    test.each`
        ...
        ${"BTC"}   | ${pairs["BTC/BTC"].blockexplorer_url}   | ${"bcrt1qh47qjmkkdxmg8cjxhe7gnnuluwddcw692cfjsv"}
        ${"L-BTC"} | ${pairs["L-BTC/BTC"].blockexplorer_url} | ${"el1qqfvxkyk2973r8y0dd42ce34r33gplzaharn0sj69qs6gvkua0r0evkk6skde36hgfx2gufy8s8ppdz54kqwkcn9az63n5pcj3"}
    `(
    ...
    test.each`
        asset      | baseLink                                | txId
        ${"BTC"}   | ${pairs["BTC/BTC"].blockexplorer_url}   | ${"813c90372c9b774396c66099cf8015f9510a8ba5686cbb78d8e848959fe7bb5d"}
        ${"L-BTC"} | ${pairs["L-BTC/BTC"].blockexplorer_url} | ${"9193b769c217808a17a86890195851eab78fdfd2f14d877163587327620324af"}
    `(
