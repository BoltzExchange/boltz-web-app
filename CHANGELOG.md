...
- add HTTP timeouts to Alchemy requests - ([d7d40ba](https://github.com/BoltzExchange/boltz-web-app/commit/d7d40bafca2c506557707a4bad794368fd67fe18))
- slippage setting drift - ([006d58e](https://github.com/BoltzExchange/boltz-web-app/commit/006d58ebac36b8044b2787cebe72c7231f71f8b7))
- WalletConnect multiple inits (#1222) - ([0af2ae7](https://github.com/BoltzExchange/boltz-web-app/commit/0af2ae7abf7781d674ceaf8a18f251ac987306b7))
- use pair hashes again - ([10c9cff](https://github.com/BoltzExchange/boltz-web-app/commit/10c9cff060d93cb4d6412fd7df8fea46d4fa9dcc))
- nice error message for rejected transactions - ([ccca155](https://github.com/BoltzExchange/boltz-web-app/commit/ccca155e094d94e03c28ae5744c94bb32b8dbe3c))
- avoid reload after network switch - ([33c7059](https://github.com/BoltzExchange/boltz-web-app/commit/33c705942d091d8a67d7794b20a960cc05302fdf))
- tugrik symbol for USDT - ([ac4ea41](https://github.com/BoltzExchange/boltz-web-app/commit/ac4ea41043421f382ef38e518101c2a8fc15eb66))
- show already refunded for EVM refunds - ([df67a0b](https://github.com/BoltzExchange/boltz-web-app/commit/df67a0b9ecf9c035e7765710cd9951ecbd801279))
- persist half signed commitment lockups - ([d3c7c31](https://github.com/BoltzExchange/boltz-web-app/commit/d3c7c3115edab3d4b4acf50b024f03d7723a6c6a))
- creation data off by one (#1238) - ([7c88e89](https://github.com/BoltzExchange/boltz-web-app/commit/7c88e895599dc099ae19f1e7d80ebc9187ae4568))
- do not show routing fee limit for invalid pairs (#1241) - ([3a2b217](https://github.com/BoltzExchange/boltz-web-app/commit/3a2b2177c0f8b0f243447be26821fd8b2a8ef173))
- amount for OFT sweeps - ([f84f1e7](https://github.com/BoltzExchange/boltz-web-app/commit/f84f1e7f2bcba031fbfa26b97c9e722d93e44276))
- builds without git history - ([cef100c](https://github.com/BoltzExchange/boltz-web-app/commit/cef100c25d21f2c1f6dcbf13a98b058fce3a65f3))
- connect wallet mismatch for contract check - ([ca2077c](https://github.com/BoltzExchange/boltz-web-app/commit/ca2077cb79db4dbdabfc6edf51bec7468c58fcd9))
- show TransactionClaimed component on InvoicePaid status (#16) - ([eeec3c7](https://github.com/BoltzExchange/boltz-web-app/commit/eeec3c7920b2e32332a91b0a51f24283d4921b67))
- validate if send asset is allowed (#15) - ([c073daf](https://github.com/BoltzExchange/boltz-web-app/commit/c073daf793832207edc2ff6bb9c31e24dfb7d474))
- hardware wallet for non RSK EVM chains (#14) - ([897b87f](https://github.com/BoltzExchange/boltz-web-app/commit/897b87f98301f81a9058d0174ec66c701e44ea39))
- bigint replacer for logs - ([980c842](https://github.com/BoltzExchange/boltz-web-app/commit/980c842346e307dd4320f83864dbc51808f35f41))
- EIP-1559 on hardware signers (#24) - ([df857e5](https://github.com/BoltzExchange/boltz-web-app/commit/df857e53c5fb9454a33a5a98b55073119450789b))
- EIP-1559 on hardware signers - ([62b9b87](https://github.com/BoltzExchange/boltz-web-app/commit/62b9b87d3ff92ec0ea2de2379aedf2dfc68a8927))
- TBTC receive amount with gas topup - ([1dcd58d](https://github.com/BoltzExchange/boltz-web-app/commit/1dcd58d29e93f02f2b2296e447918626898fd65b))
- get message fee for OFT refunds - ([23982fe](https://github.com/BoltzExchange/boltz-web-app/commit/23982fea2199c3564e653d75b77c3d8df32db19b))
- guard against reading OFT of null - ([ede4455](https://github.com/BoltzExchange/boltz-web-app/commit/ede4455e3a9d7150b1e588d429940c76b2ba582d))
- OFT on ETH L1 (#1259) - ([ae8167d](https://github.com/BoltzExchange/boltz-web-app/commit/ae8167d3063d886a5f6120a61a1d6bc3e8eba68b))
- OFT send amount fee calculation (#1261) - ([91d384e](https://github.com/BoltzExchange/boltz-web-app/commit/91d384eb4e749120edee18a9d6d36e78b7d229ba))
- asset order in selector (#1265) - ([382c73b](https://github.com/BoltzExchange/boltz-web-app/commit/382c73b43d816ae1ec01e32a3168c6d1a4f5b8eb))
- routed refunds (#1271) - ([f8f49fd](https://github.com/BoltzExchange/boltz-web-app/commit/f8f49fdadef6c8ccb2b9cf64dce587f1fda5c511))
- preserve refund tx button (#1270) - ([6cf53e7](https://github.com/BoltzExchange/boltz-web-app/commit/6cf53e7235ad55d9e37cc4efede630c4c515bcb1))
- amount below minimum value after clicking "min" (#1280) - ([2b2cd7b](https://github.com/BoltzExchange/boltz-web-app/commit/2b2cd7b6321320b3a2ab8bb9d887842ef67c04fa))
- USDT and LN icon sizes (#1285) - ([c91478a](https://github.com/BoltzExchange/boltz-web-app/commit/c91478a7fe0531502edcf75b0918af35602789dc))
- USDT 0-amount chain swap (#1289) - ([c1f0605](https://github.com/BoltzExchange/boltz-web-app/commit/c1f06051d00c8a033d75e580249207534326af05))
- allow 0-amount chain swaps with post OFT (#1293) - ([fe91b65](https://github.com/BoltzExchange/boltz-web-app/commit/fe91b65668e5c3d72d0c336bb8d3941f9af60d4d))
- 0-amount receive with OFT (#1295) - ([1a051b9](https://github.com/BoltzExchange/boltz-web-app/commit/1a051b936bea697057196067f89a24135f1d2088))
- harden OFT swap worker - ([0aaef7e](https://github.com/BoltzExchange/boltz-web-app/commit/0aaef7eb1e0c52ce92dfd9b8d391c9c5653f2789))
- backfill missed OFT commitment - ([69a5580](https://github.com/BoltzExchange/boltz-web-app/commit/69a5580418c5772d8a52bb250703cdc88ab2ac46))
- reset ERC20 approval if needed (#1299) - ([90d69db](https://github.com/BoltzExchange/boltz-web-app/commit/90d69db24eba05121cabcf1827770c49bed46527))
- input validation race (#1303) - ([4396db4](https://github.com/BoltzExchange/boltz-web-app/commit/4396db49b7a3ac9dff617d6e5ce26e30a4d4c48f))
- recover from Alchemy fail on pre OFT lockup (#1308) - ([d092566](https://github.com/BoltzExchange/boltz-web-app/commit/d09256660aa44713c5528e85892ea939f76e26ec))
- clear invoice when amounts change - ([6b35728](https://github.com/BoltzExchange/boltz-web-app/commit/6b357288dc425f23c92939292146a6854b9ed1a3))
- run generate in Docker builds (#1318) - ([f30cb5f](https://github.com/BoltzExchange/boltz-web-app/commit/f30cb5fe9a6e9798409937789c1a85681fb52691))
- OFT refund followup (#1320) - ([39c48fa](https://github.com/BoltzExchange/boltz-web-app/commit/39c48faa02f5d08983cf31c26e63bed537d29b91))

### Features

- USDT0 swaps - ([ab97e08](https://github.com/BoltzExchange/boltz-web-app/commit/ab97e08873b848f90f729717fe7e8a0f60b765f6))
- dynamic WalletConnect config (#1210) - ([ceff4ad](https://github.com/BoltzExchange/boltz-web-app/commit/ceff4add07682b61d22b6c9cdee62ecdd957ee6c))
- show loading indicator for quote fetching - ([e912a0f](https://github.com/BoltzExchange/boltz-web-app/commit/e912a0fed990c925f830d07c916c3da1896a8557))
- commitment refunds - ([a16a32f](https://github.com/BoltzExchange/boltz-web-app/commit/a16a32f408f4a4dfd1515fb03345d08bd5773579))
- allowing sending to external EVM addresses - ([1e8fa20](https://github.com/BoltzExchange/boltz-web-app/commit/1e8fa2051632c25b96c6e3fe56b0c891d98c7f89))
- refund to original token for routed swaps (#1234) - ([f0c50e9](https://github.com/BoltzExchange/boltz-web-app/commit/f0c50e95ea99641138de552af1392d21231fe3e4))
- receive extra gas token when going to ERC20 (#1225) - ([ab37aed](https://github.com/BoltzExchange/boltz-web-app/commit/ab37aedd2ffa58d8d9ce6256ee3df2e15dade26b))
- send to USDT0 OFT - ([d245776](https://github.com/BoltzExchange/boltz-web-app/commit/d2457763ea0faad44ad99d07e62c56c1b0401103))
- show OFT messaging fee - ([2a801a3](https://github.com/BoltzExchange/boltz-web-app/commit/2a801a37a6ae8677e90185522517820d8d67d6c0))
- add multi-step asset selection (#2) - ([b33f71f](https://github.com/BoltzExchange/boltz-web-app/commit/b33f71f41b5c92f98464722415e217dd1e7f132b))
- asset selection search (#5) - ([ba528c5](https://github.com/BoltzExchange/boltz-web-app/commit/ba528c54abf0795ff0906b6fd0787b61c1b93bce))
- send via OFT - ([4c0a90b](https://github.com/BoltzExchange/boltz-web-app/commit/4c0a90b0c31c7f0e9e7bf0fdee7a79c470ee4156))
- forward gas in OFT send - ([0330cd1](https://github.com/BoltzExchange/boltz-web-app/commit/0330cd13bbf20cf6134af38ded41fc715fccaea8))
- USDT0 -> USDT (#12) - ([3c3c41b](https://github.com/BoltzExchange/boltz-web-app/commit/3c3c41b58790d8a492c4f86f24218a809eed056c))
- Bitcoin-Only Mode (#18) - ([58fc3b7](https://github.com/BoltzExchange/boltz-web-app/commit/58fc3b75035001a93d74613b5afd71827509ca7f))
- also check native balance for OFT lockup - ([009219d](https://github.com/BoltzExchange/boltz-web-app/commit/009219de3e5644094e264d617025499f47bdd7c6))
- fallback RPC provider - ([62f4361](https://github.com/BoltzExchange/boltz-web-app/commit/62f43618f6b8a9b2dda56de461ccf6abdb7b5062))
- refund back to OFT - ([d1679b3](https://github.com/BoltzExchange/boltz-web-app/commit/d1679b3ea514fe50c4e234a08b12d19b0e7543fb))
- show OFT lockup transaction link - ([d38af0c](https://github.com/BoltzExchange/boltz-web-app/commit/d38af0c507d1ee2ed3888d66d1e3cfc49222945a))
- notify user when changing assets in bitcoin-only mode (#1255) - ([28d379b](https://github.com/BoltzExchange/boltz-web-app/commit/28d379ba20f3ebaaa21d8ff8321c0a323891d679))
- flip amount and assets for USDT swaps (#1277) - ([67a1a58](https://github.com/BoltzExchange/boltz-web-app/commit/67a1a5813e7b7989d9919d948584f28a462eb8f0))
- resume external TBTC swaps (#1263) - ([dcd3401](https://github.com/BoltzExchange/boltz-web-app/commit/dcd3401dd29c1c808a9fe0200fa9bc0b961c46ca))
- USDT chain swaps (#1274) - ([ccf67b8](https://github.com/BoltzExchange/boltz-web-app/commit/ccf67b857101b1576a6391bb55e8f048576ddd23))
- oft legacy mesh receive (#1275) - ([2a9e8a5](https://github.com/BoltzExchange/boltz-web-app/commit/2a9e8a5d51af52f57ee29cbab9ac8a353708257b))
- Tempo support (#1302) - ([5dc24dc](https://github.com/BoltzExchange/boltz-web-app/commit/5dc24dc0704fc85afdd7057f78f4e9f7269d8ce6))
- fee collapse (#1300) - ([1212f99](https://github.com/BoltzExchange/boltz-web-app/commit/1212f99a7927851d252bfc0337911d2a7fa58e1f))
- show quote loading when pasting invoice - ([47806e2](https://github.com/BoltzExchange/boltz-web-app/commit/47806e29437f6c7191e53ebcea96caff2a0b4d75))
- add loading skeleton to swap limits - ([0b5884a](https://github.com/BoltzExchange/boltz-web-app/commit/0b5884a2abda1a173d83bbf2e227237f3b6a347a))
- Solana send support (#1305) - ([4691673](https://github.com/BoltzExchange/boltz-web-app/commit/46916730112ecb9358893365d6882053d9863ef8))

### Miscellaneous Chores

- add simplex bot link to swap box in pro build (#1221) - ([e3c0e8c](https://github.com/BoltzExchange/boltz-web-app/commit/e3c0e8c8050f07d712e75d7bdc54b6d6fcea1d47))
- fix misc review comments - ([8d213f5](https://github.com/BoltzExchange/boltz-web-app/commit/8d213f5e1ac4a02cd3e69f47fc6b6b002ec2cf88))
- enable on mainnet - ([84e6953](https://github.com/BoltzExchange/boltz-web-app/commit/84e695368a2a31ed0181ed96adcf44a1d8e83169))
- switch tbtc logo to vector svg (#1239) - ([c391011](https://github.com/BoltzExchange/boltz-web-app/commit/c3910117e2c74079f242b3d9c93265487b8cd386))
- switch tbtc logo (#1243) - ([1c5f75f](https://github.com/BoltzExchange/boltz-web-app/commit/1c5f75f17cf9326a5d0547d97d4dc7088dcd0349))
- relax CI for non-gh runners (#1244) - ([ceb4530](https://github.com/BoltzExchange/boltz-web-app/commit/ceb4530bb1b7c93c045a6f38a07870f839524764))
- add USDT0 Hedera - ([b66f452](https://github.com/BoltzExchange/boltz-web-app/commit/b66f452659cbd353d294b1ef06759de995dedb3a))
- add .vercel to .gitignore - ([43e4bda](https://github.com/BoltzExchange/boltz-web-app/commit/43e4bda17b6cc277fc9f6247426668a9b7e5abf5))
- add .vercelignore - ([f1122e7](https://github.com/BoltzExchange/boltz-web-app/commit/f1122e7ea3c3177b57539e7485792857903c64ff))
- cleanup USDT0 networks - ([674f5b3](https://github.com/BoltzExchange/boltz-web-app/commit/674f5b3290991d38d48d34c5d24efd77ade15d1c))
- asset selection cleaner keyboard focus - ([6878392](https://github.com/BoltzExchange/boltz-web-app/commit/687839201f48f45f329127297dfe8fd49978fb93))
- cleanup unused icons - ([e7ad739](https://github.com/BoltzExchange/boltz-web-app/commit/e7ad7399ca26f3b3670caf06f3a50e523f741824))
- update OFT wording - ([f5be1ef](https://github.com/BoltzExchange/boltz-web-app/commit/f5be1efb599fdc9f7dddab4a8f20ba40a7233b33))
- address review - ([10a4bca](https://github.com/BoltzExchange/boltz-web-app/commit/10a4bcaec521cb9ffa5ed8c71d96788a3c38cc53))
- address review feedback - ([5974773](https://github.com/BoltzExchange/boltz-web-app/commit/59747735127a4d5bb604e176f7611d2ff7ed3136))
- address review comments - ([d0d9f87](https://github.com/BoltzExchange/boltz-web-app/commit/d0d9f87a93300006a593487ddf746fb2b0787ebf))
- disable chain swap route (#1273) - ([f6230d5](https://github.com/BoltzExchange/boltz-web-app/commit/f6230d583a8a9c2d7ca7cdea213c1184068e9175))
- log version and commit hash on load (#1276) - ([000c42c](https://github.com/BoltzExchange/boltz-web-app/commit/000c42c8333f7981f205e50908161c471f7dbe2b))
- bump h3 from 1.15.5 to 1.15.10 (#1278) - ([8cde66c](https://github.com/BoltzExchange/boltz-web-app/commit/8cde66cdb91007820bd3d185fd7a4fe9c9bbfae8))
- update GitHub action dependencies (#1288) - ([1caa25d](https://github.com/BoltzExchange/boltz-web-app/commit/1caa25dcaa6b950aaabde0c9ef2c76f284362628))
- add Alchemy endpoint for Polygon (#1294) - ([80ed83b](https://github.com/BoltzExchange/boltz-web-app/commit/80ed83b5d7cce663db3173bc9fcb7605da071311))
- bump Vite to v8 - ([ab9d964](https://github.com/BoltzExchange/boltz-web-app/commit/ab9d964252769175500b4949051695dd9151af15))
- bump TypeScript to v6 - ([cef4537](https://github.com/BoltzExchange/boltz-web-app/commit/cef45375d6f9d8b00b96885b5cbb204e4568d53d))
- misc dependency updates - ([ee31b3e](https://github.com/BoltzExchange/boltz-web-app/commit/ee31b3e137d6f62131073713f6b36a27899b1698))
- bump bignumber.js - ([2a9d361](https://github.com/BoltzExchange/boltz-web-app/commit/2a9d3613a7be8e5bf6051a1db0b77d5569871fb8))
...
- slippage cleanup - ([a1f6c63](https://github.com/BoltzExchange/boltz-web-app/commit/a1f6c635cc0636b520c204893e858cffa574e23e))
- preimage derivation based on chain id - ([feda38d](https://github.com/BoltzExchange/boltz-web-app/commit/feda38d7dc3714dc70fa5c32a40555a9e8eb17b7))
- gas abstraction enum - ([2526711](https://github.com/BoltzExchange/boltz-web-app/commit/25267111d96746ed64e3e1be1f381a33e350531f))
- generic gas abstraction - ([c1efd5c](https://github.com/BoltzExchange/boltz-web-app/commit/c1efd5c7c7648867088a15ce7e08a1aafff8d3ce))
- sort quotes in api client - ([5cf76d8](https://github.com/BoltzExchange/boltz-web-app/commit/5cf76d82db35e81a9b12cb34f2dab1f65f21e26d))
- LayerZero explorer for OFT claim txs - ([75d431c](https://github.com/BoltzExchange/boltz-web-app/commit/75d431c4974e4b96f7a4be4f20e3f046018ada6f))
- cleanup USDT0 send - ([4c20f68](https://github.com/BoltzExchange/boltz-web-app/commit/4c20f68ae0011824feb981b5dccdbdfc50781bae))
- cleanup OFT pre swap - ([ff45b22](https://github.com/BoltzExchange/boltz-web-app/commit/ff45b229f610c25ae3719ada1520722204988d02))
- harden OFT handler with retries - ([2c2b2ce](https://github.com/BoltzExchange/boltz-web-app/commit/2c2b2ce68f18c26a46f2af7264ca1d3fe6209337))
- show OFT transaction link for refunds - ([613fd81](https://github.com/BoltzExchange/boltz-web-app/commit/613fd813c8ccd3eee624a35633cf76bc482db034))
- cleanup LayerZero block explorer links - ([e658b86](https://github.com/BoltzExchange/boltz-web-app/commit/e658b86cfe0a6e820e0758b1e866ea29d12de143))
- cleanup after rabbit review - ([f6a3dde](https://github.com/BoltzExchange/boltz-web-app/commit/f6a3ddede358d28ded0d362b63ad538892f42c65))
- normalize L-BTC to LBTC and USDT0 to USDT (#1262) - ([bac1ff8](https://github.com/BoltzExchange/boltz-web-app/commit/bac1ff8db15ac561176f7a3e512a7f16771097f7))
- require Rescue Key backup for all but reverse swaps (#1269) - ([949b47e](https://github.com/BoltzExchange/boltz-web-app/commit/949b47e7b816017c85cb0b42aafd559a98530b25))
- improve backup flow by creating swap first (#1286) - ([7c739c0](https://github.com/BoltzExchange/boltz-web-app/commit/7c739c056719e753552e68b9aa30110aee24d3ae))
- rescue key backup in mobile EVM browsers (#1311) - ([e14de9e](https://github.com/BoltzExchange/boltz-web-app/commit/e14de9e411d08c6aeda05a80c5355af6d49fbcdb))
- switch to bolt12-utils (#1260) - ([980e138](https://github.com/BoltzExchange/boltz-web-app/commit/980e138774f1d3bd4c47e0c8d75ade9a7f46923d))
- oft fee adjustments (#1314) - ([8229909](https://github.com/BoltzExchange/boltz-web-app/commit/8229909367d2d6f154688d4b54fbefc2eaeec21d))
- refund to OFT without leaving dust - ([d169171](https://github.com/BoltzExchange/boltz-web-app/commit/d1691710c51b1f7315e97bf973b3e6a6ce8e7310))
- unify hops and oft position (#1321) - ([9036977](https://github.com/BoltzExchange/boltz-web-app/commit/903697785f2c4da995a2c446acac3d332c2f29d1))

### Tests

- make mainnet RPC test more resilient - ([68c51a8](https://github.com/BoltzExchange/boltz-web-app/commit/68c51a8e96dafa655468674d0818855626e85535))
...
- bump version to v1.8.18 (#1212) - ([010658f](https://github.com/BoltzExchange/boltz-web-app/commit/010658fe93e908d9131fb7386d36d7868001cee3))
